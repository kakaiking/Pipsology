...
export default function LearnLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex bg-[#0a0f0d]">
            ...
            <main className={`flex-1 transition-all duration-300 min-h-screen relative ${isCollapsed ? "pl-16" : "pl-72"}`}>
                <div className="pt-[10px] pb-12 px-4 md:px-8 w-full max-w-[1600px]">
                    {children}
                </div>
            </main>
        </div>
